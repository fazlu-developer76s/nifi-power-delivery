                            ...
                            <table id="data-table-default" class="table table-striped table-bordered align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Service No</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($lead->lead_create_date)->format('d F Y h:i A') }}</td>
                                        ...
                                        <td> <div class="loan_status {{ $loan_status }}">{{ str_replace('_',' ',$loan_status) }}</div>   </td>
                                        <td>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault{{ $lead->id }}" {{ ($lead->status==1) ? 'checked' : '' }}  onchange="ChangeStatus('loan_requests',{{ $lead->id }});" >
                                              </div>
                                        </td>
